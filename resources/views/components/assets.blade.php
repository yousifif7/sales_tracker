...
@else
    ...
    <style>
        ...
        @media (max-width: 1023px) {
            [data-desktop-main] { margin-left: 0 !important; width: 100%; }
        }
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var desktopSidebarMedia = window.matchMedia('(min-width: 1024px)');
            if (sidebarRail && sidebarToggle) {
                var applyDesktopSidebarLayout = function (collapsed) {
                    ...
                    if (desktopSidebarMedia.matches) {
                        ...
                        if (desktopMain) desktopMain.style.marginLeft = '';
                    }
                ...
                desktopSidebarMedia.addEventListener('change', function () {
