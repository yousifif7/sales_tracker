...
@else
    ...
    <style>
        ...
        .panel { border-radius: 1.5rem; border: 1px solid #1e293b; background: rgba(15, 23, 42, 0.7); padding: 1.5rem; box-shadow: 0 25px 50px -12px rgba(2, 6, 23, 0.3); }
        ...
        .input { margin-top: 0.5rem; width: 100%; border-radius: 1rem; border: 1px solid #334155; background: #020617; padding: 0.75rem 1rem; color: #f1f5f9; }
        ...
        .table-wrap { overflow: hidden; border-radius: 1.5rem; border: 1px solid #1e293b; background: rgba(15, 23, 42, 0.7); }
        .table { width: 100%; min-width: 100%; border-collapse: collapse; text-align: left; font-size: 0.875rem; color: #cbd5e1; }
        .table th { background: #0f172a; padding: 0.75rem 1rem; font-size: 0.75rem; font-weight: 600; letter-spacing: 0.2em; text-transform: uppercase; color: #64748b; }
        .table td { padding: 1rem; vertical-align: top; border-top: 1px solid #1e293b; }
        .table-compact th, .table-compact td { padding: 0.625rem 0.75rem; }
