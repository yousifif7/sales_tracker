@php
    ...
    $navItems = [
        ...
        ['route' => 'sequences.index', 'label' => 'Sequences', 'permission' => Permissions::EMAILS_SEND, 'icon' => 'sequences'],
    ...
    $renderNavIcon = static function (string $icon): string {
        return match ($icon) {
            ...
            'sequences' => '<path d="M4.75 3h6.5A1.75 1.75 0 0 1 13 4.75v6.5A1.75 1.75 0 0 1 11.25 13h-6.5A1.75 1.75 0 0 1 3 11.25v-6.5A1.75 1.75 0 0 1 4.75 3M5.5 9.25h1.25V6.5H5.5zm2.38 0h1.24V5h-1.24zm2.37 0H11.5v4.25H10.25z"/>',
